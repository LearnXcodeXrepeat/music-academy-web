...
const UpcomingWebinar = () => {
  const showWebinar = webinarsList.filter((list: webinar) => list.isFeatured);
  return (
...
export const webinarsList = [
  ...
  },
  {
    title: "Understanding ",
    description:
      "Dive  fundamentals of music theory and enhance your musical skills.",
    link: "theory",
    isFeatured: false,
  },
  {
